...
- **[RG351V]** The Ports install hasn't been tried on the V yet. Works on the RPP and the V90S, same script.
- **PortMaster** 8.6.1 is bundled, but only exercised with AM2R on the RG351V. Same payload on the other two, untested.
- **[V90S]** Neo Geo Pocket, PC Engine, SNES and 2600 couldn't launch before release — leftover core names from the RG351V build. Fixed, not yet played.
...
- **[V90S]** SNES runs on `snes9x_next`. KNULLI has no supafaust. If SNES drags, blame that first.
